...
Installs Gemini CLI, Google's open-source AI agent for terminal access to Gemini models. Requires Node.js 20+.
...
|-----|-----|-----|-----|
| version | Version of Gemini CLI to install (e.g., 'latest', '1.0.0') | string | latest |
