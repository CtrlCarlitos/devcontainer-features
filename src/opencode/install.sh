...
if ! verify_cli_installation "opencode"; then
    echo "ERROR: Feature \"$FEATURE_NAME\" (Unknown) failed to install! Look at the documentation at https://github.com/opencode-ai/opencode for help troubleshooting this error."
    exit 1
fi
